...
public:
    ...
    float rating_at_day_start;          // Rating at the start of current day (for display)
    int daily_orders_confirmed;         // Orders confirmed this day (for display)
    int daily_orders_cancelled;         // Orders cancelled this day (for display)
